	...
	initialize(instance) {
		if (Prism) {
			Prism.languages.surql = {
				...
				variable: /[$][\w.]+/,
				function: /\b(?:fn|function|count|sleep|rand|(?:(array|crypto|duration|fn|geo|http|is|math|meta|object|parse|rand|search|session|sleep|string|time|type|vector)::[\w]+)(::[\w]+)?)(?=\s*\()/i,
